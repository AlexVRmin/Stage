...
<form action="../Email?/denied" method="post" class="flex flex-col w-2/4 m-2/4">
    ...
    {#if Array.isArray(data2)}
        ...
        {/each}
    {/if}
    <label for="reason">Waarom is deze bestelling geweigerd?</label>
    <textarea name="reason" rows="5" cols="33" required></textarea>
