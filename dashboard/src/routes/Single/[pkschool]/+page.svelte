        ...
        <section class="w-3/4">
          ...
          <div class="bg-white px-9 py-4">
            {#each contract as contracten}
              ...
              {/if}
              <div class="record">
                  <span class="w-48">{contracten.Naam}</span> <!--style-->
                  <span class="w-40">{contracten.PCN}</span> <!--style-->
                  <span class="w-40">{contracten.Startdatum}</span> <!--style-->
                  <span class="w-40">{contracten.Einddatum}</span> <!--style-->
              </div>
                <a class="px-4 py-0.5 bg-edutech-orange rounded-2xl" href={`/Licences/${contracten.PKcontract}`}>View</a> <!--style-->
            {/each}
